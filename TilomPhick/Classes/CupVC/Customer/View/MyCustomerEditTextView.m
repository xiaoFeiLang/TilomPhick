...
@interface MyCustomerEditTextView ()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) MyCustomerTextView *topTextView;
@property (nonatomic, strong) UIViewController *controller;
@end
@implementation MyCustomerEditTextView
...
-(instancetype)initWithController:(UIViewController *)controller{
    ...
    if(self){
        ...
        MyCustomerTextView *topTextView=[[MyCustomerTextView alloc]initWithFrame:CGRectMake(15, controller.view.bounds.size.height/3, controller.view.bounds.size.width-30, controller.view.bounds.size.height/3)];
...
+(instancetype)showWithController:(UIViewController *)controller{
    MyCustomerEditTextView *editTextView=[[self alloc]initWithController:controller];
...
+(void)showWithController:(UIViewController *)controller andRequestDataBlock:(void(^)(NSString *text))requestDataBlock{
    MyCustomerEditTextView *edit=[MyCustomerEditTextView showWithController:controller];
