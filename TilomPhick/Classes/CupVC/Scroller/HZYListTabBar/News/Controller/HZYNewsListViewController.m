...
//    [LXNetworking getWithUrl:UrlString params:nil success:^(id response) {
//        NSDictionary *rootDict = [NSJSONSerialization JSONObjectWithData:response options:NSJSONReadingAllowFragments error:nil];
...
//    } showHUD:false];
    ...
    [HttpTool get:UrlString params:nil success:^(id responseObj) {
        NSDictionary *rootDict = [NSJSONSerialization JSONObjectWithData:responseObj options:NSJSONReadingAllowFragments error:nil];
        NSArray *news = [HZYNewsModel objectArrayWithKeyValuesArray:rootDict[@"result"]];
